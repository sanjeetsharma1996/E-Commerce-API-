    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=True)),
                ('date_created', models.DateField(auto_now_add=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='Books_APP_API.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books', models.ManyToManyField(to='Books_APP_API.book')),
                ('products', models.ManyToManyField(to='Books_APP_API.product')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='book',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='Books_APP_API.category'),
        ),
        migrations.AddField(
            model_name='book',
            name='created_by',
